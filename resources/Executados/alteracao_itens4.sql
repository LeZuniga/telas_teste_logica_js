...
IF EXISTS ( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE  TABLE_NAME='Item_Filter_Criteria' AND COLUMN_NAME='Item_Filter_Criteria' )
	alter table Item_Filter_Criteria drop column Default_duration_Development;	
...
EXEC sp_rename 'Item_Filter_Criteria.Create_Date_Proper_Begin', 'Creation_Date_Proper_Begin', 'COLUMN';
EXEC sp_rename 'Item_Filter_Criteria.Create_Date_Proper_End', 'Creation_Date_Proper_End', 'COLUMN';
EXEC sp_rename 'Item_Filter_Criteria.Create_Date_Erp_Begin', 'Creation_Date_Erp_Begin', 'COLUMN';
EXEC sp_rename 'Item_Filter_Criteria.Create_Date_Erp_End', 'Creation_Date_Erp_End', 'COLUMN';
