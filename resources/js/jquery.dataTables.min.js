...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processando...",sLengthMenu:"_MENU_ dados",sZeroRecords:"Nenhum registro foi encontrado",sEmptyTable:"Não há dados disponíveis na tabela",
sLoadingRecords:"Carregando...",sInfo:"Visualizando de _START_ à _END_ do total de _TOTAL_ dados",sInfoEmpty:"Visualizando de 0 à 0 do total de 0 dados",sInfoFiltered:"(filtrando _MAX_ dados)",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primeira",sPrevious:"Anterior",sNext:"Próxima",sLast:"Última"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",bRegex:false,
