...
//      Lembrar que, em javascript, quando você faz arrays de cópia, ele copia por referência, o que faz com que possa causar algumas confusões, pode
//      ser que alguma das suas soluções precise, de alguma forma, fazer cópia de arrays:
//      Ex:
//          var array1 = [1,2,3]
//          var array2 = array1;
//          array2[0] = 'B'  
  ...
  function procuraPessoa(pessoa){
    ...
    function acharPessoaPorId(id){
      ...
      if(dadosDeCadastro = dadosCadastroPessoa.filter(item=>item.id === id)[0]){
         ...
         } else { return console.log("Id não encontrado");}
      }
